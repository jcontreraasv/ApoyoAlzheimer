...
import kotlinx.android.synthetic.main.activity_agregar_consejo_usuario.*
import java.io.File
import java.io.FileOutputStream
import java.lang.Exception

class AgregarConsejoActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_agregar_consejo_usuario)

        btn_guardarConsejoUser.setOnClickListener{
            registrarConsejoUser()
        }
    }

    fun registrarConsejoUser() {
    ...
    public fun registrar(){
        ...
        var titulo = tituloConsejo_usuario.text.toString()
        var cuerpo = contenidoConsejo_usuario.text.toString()
    ...
    private fun ubicacion(): String{
        val carpeta = File(Environment.getExternalStorageDirectory(), "consejosUsuario")
        if(!carpeta.exists()){
            carpeta.mkdir()
        }
